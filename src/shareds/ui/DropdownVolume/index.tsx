...
import { IDropDownVolumeProps } from './types';
import { ArrayRender } from '../../utils/components';
import { DropdownVolumeListItem } from './DropdownVolumeListItem';

export const DropdownVolume: FC<IDropDownVolumeProps> = ({
  options,
  className,
  setSelectedOption,
  selectedOption,
    ...
    <div ref={dropdownRef} className={styles.dropdownWrap}>
      ...
      >
        <div className={styles.text}>
          ...
          <span>{selectedOption?.volume ? `${selectedOption?.volume} мл` : 'Не указан'}</span>
        </div>
